...
\begin{table}[h!]
	...
	\begin{tabular}{|c|c|}
		...
		4 &  \\ \hline
	 	...
	 	24 &  \\ \hline
	\end{tabular}
	\caption{Runtime analysis of the PatchMatch module on a single image (GPU: NVIDIA RTX 4070 TI SUPER)}
\end{table}
\\\\
